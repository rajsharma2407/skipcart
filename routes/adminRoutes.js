...
const checkAdmin = (req,res,next)=>{
    if(process.env.SESSION_NAME == 'admin')
    next();
    else{
        res.redirect('/')
    }
...
router.post('/add-product',(req,res)=>{
    ...
    myProduct.save(err=>{
        ...
        mkdirp('public/product_images/'+myProduct._id).then(err=>{
            console.log(err)
            var path = 'public/product_images/'+myProduct._id+'/'+productImageName;
...
router.post('/edit-product/:id',(req,res)=>{
    ...
    if(product){
        ...
        var filePath = 'public/product_images/'+id+'/'+product.productImage;
